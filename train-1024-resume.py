...
def train_dqn_dynamic(reward_mode="standard", checkpoint_file=None):
    ...
    old_save_dir = f"/content/drive/MyDrive/drl-uav-512/outputs_dynamic_standard/checkpoints/checkpoints_new"
    save_dir = os.path.join(old_save_dir, "checkpoints_new2")
